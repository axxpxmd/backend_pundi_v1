<div class="form-group m-t-5">
    <label for="" class="col-form-label s-12 col-md-4">Footer</label>
    <input type="file" name="footer" id="file1" class="input-file1" onchange="tampilkanPreview1(this,'preview1')">
